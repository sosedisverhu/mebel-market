...
export const DATABASE_URL = 'mongodb://localhost/mebel-market';
...
export const PARTNERS_ITEM_FILE_FIELD_NAME_REGEX = /product-.*-file-/g;
export const PARTNERS_ITEM_AVATAR_FIELD_NAME_REGEX = /product-.*-avatar/g;
