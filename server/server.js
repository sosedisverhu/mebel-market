...
import adminNewsItemApi from './api/admin/newsItem';
import clientNewsItemApi from './api/client/newsItem';
...
app.use('/api/admin/newsItem', adminNewsItemApi);
app.use('/api/client/newsItem', clientNewsItemApi);
