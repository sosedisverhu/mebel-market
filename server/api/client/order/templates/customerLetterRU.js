...
export default function customerLetterRU (order, categories, subCategories, domain, shares) {
                ...
                <tbody><tr>
                    <td align="center" style="padding-right:20px;padding-top:5px;padding-bottom:5px;width:200px;vertical-align:top;">
                        <a href=${domain + productLink} style="text-decoration:none;line-height:0" target="_blank">
                            <img src=${domain + product.product.avatar} border="0" width="80" height="95" alt=${product.productNameRu} style="display:block;background-color:#ffffff; width: 100%; height: auto;" class="CToWUd">
                        </a>
                    </td>
                        ...
                        <table cellpadding="0" cellspacing="0" style="border:0;border-collapse:collapse;width:100%">
                            <tbody><tr>
                                <td colspan="3" style="padding:0 0 3px 0;line-height:20px">
                                    <a href=${domain + productLink} style="color:#3e77aa;font-size:15px;text-decoration:none;word-break:break-word" target="_blank">${product.productNameRu}</a><span style="white-space:nowrap;font-size:12px;color:#999999;padding-left:10px">${product.article}</span>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <table cellpadding="0" cellspacing="0" style="border:0;border-collapse:collapse;width:100%;    margin-top:10px;">
                            <tbody>
                                <tr>
                                    ...
                                    <td style="font-size:15px;width:100px;vertical-align:top;padding-top:5px;text-align: right;">${product.properties.size.nameRu}</td>
                                </tr>
                                <tr>
                                    <td style="font-size:15px;width:140px;vertical-align:top;padding-top:5px">Цвет</td>
                                    <td style="font-size:15px;width:100px;vertical-align:top;padding-top:5px;text-align: right;">${product.properties.colorRu.name}</td>
                                </tr>
