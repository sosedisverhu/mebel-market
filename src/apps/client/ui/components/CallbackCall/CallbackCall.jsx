...
import sendCallApplication from '../../../services/client/sendCallApplication';
...
const mapDispatchToProps = dispatch => ({
    sendCallApplication: payload => dispatch(sendCallApplication(payload))
});
...
class CallbackCall extends Component {
    ...
    render () {
        ...
        return (<div>
            ...
            {isPopupCall && <CallbackForm closePopup = {this.closePopup} sendCallApplication = {this.props.sendCallApplication} text={text} />}
        </div>
        );
    }
}

export default connect(mapStateToProps, mapDispatchToProps)(CallbackCall);
