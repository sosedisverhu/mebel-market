...
export default {
    ...
    product: {
        ...
        getShareDiscount2: ' при купівлі цього товару разом з одним з цих товарів',
        ...
        atChoice: '(на  вибір)',
        sharedProducts: 'Товар бере участь в акції при покупці наступних товарів:',
        share: 'Акція',
    ...
    callback: {
        ...
        firstField: "Ім'я",
        secondField: 'Телефон',
        text: <div>Наш менеджер з Вами звяжется в найближчий час! <br/>
            Якщо Ваше питання не може чекати, подзвоніть нам по номеру <a href='tel:+380679000522'>+380679000522</a></div>,
    ...
    customSize: {
        ...
        subTitle: 'Замовлення настандартного розміру',
        width: 'Ширина (см)',
        height: 'Довжина (см)',
        description: 'Матрас можна виготовити з нестандартним розміром з кроком у 2см',
        inputs: {
            name: 'Ім\'я',
            mail: 'Ел.пошта',
            phone: 'Телефон'
        },
        agreement: 'Я приймаю умови оброблення й захисту персональних данних',
        order: 'Замовити розрахунок'
    }
};
